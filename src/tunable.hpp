...
TUNABLE(HISTORY_BONUS_BASE, 159, 0, 0, 0);
TUNABLE(HISTORY_BONUS_DEPTH_SCALE, 101, 0, 0, 0);
TUNABLE(HISTORY_BONUS_MAX, 1818, 0, 0, 0);

TUNABLE(HISTORY_PENALTY_BASE, 112, 0, 0, 0);
TUNABLE(HISTORY_PENALTY_DEPTH_SCALE, 155, 0, 0, 0);
TUNABLE(HISTORY_PENALTY_MAX, 1710, 0, 0, 0);
// FIXME
...
TUNABLE(SE_MIN_FDEPTH_PV_SCALE, 128, 0, 0, 0);
...
TUNABLE(SE_TRIPLE_FEXT_MARGIN_NOISY_SCALE, 199, 0, 0, 0);
