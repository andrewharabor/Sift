...
namespace Sift {
    ...
    TUNABLE(MAIN_HIST_UPDATE_WEIGHT, 1001, 512, 2048);
    TUNABLE(PAWN_HIST_UPDATE_WEIGHT, 826, 512, 2048);
    TUNABLE(CONT1_HIST_UPDATE_WEIGHT, 1057, 512, 2048);
    TUNABLE(CONT2_HIST_UPDATE_WEIGHT, 1204, 512, 2048);
    TUNABLE(CONT4_HIST_UPDATE_WEIGHT, 829, 512, 2048);
    TUNABLE(CONT6_HIST_UPDATE_WEIGHT, 924, 512, 2048);
    TUNABLE(CAPTURE_HIST_UPDATE_WEIGHT, 1074, 512, 2048);
    ...
    TUNABLE(CORR_HIST_BONUS_MAX, 219, 64, 2048);
    TUNABLE(CORR_HIST_PENALTY_MAX, 451, 64, 2048);

    TUNABLE(PAWN_CORR_HIST_WEIGHT, 50, 16, 128);
    TUNABLE(FRIENDLY_NONPAWN_CORR_HIST_WEIGHT, 39, 16, 128);
    TUNABLE(ENEMY_NONPAWN_CORR_HIST_WEIGHT, 36, 16, 128);
    TUNABLE(MINOR_PIECE_CORR_HIST_WEIGHT, 29, 16, 128);
    ...
    TUNABLE(CONT4_CORR_HIST_WEIGHT, 43, 16, 128);
