...
TUNABLE(TTABLE_REPLACE_DEPTH_MARGIN, 2, 0, 0, 0);
TUNABLE(TTABLE_REPLACE_DEPTH_PV_SCALE, 2, 0, 0, 0);
...
TUNABLE(AVG_SCORE_INTERPOLATION_COEFF, 8, 0, 0, 0);
...
TUNABLE(NMP_MIN_PLY_DEPTH_SCALE, 3, 0, 0, 0);
TUNABLE(NMP_MIN_PLY_DEPTH_DIVISOR, 4, 0, 0, 0);

TUNABLE(PROBCUT_MIN_DEPTH, 5, 0, 0, 0);
TUNABLE(PROBCUT_BETA_MARGIN, 190, 0, 0, 0);
TUNABLE(PROBCUT_TABLE_DEPTH_MARGIN, 3, 0, 0, 0);
TUNABLE(PROBCUT_REDUCTION, 4, 0, 0, 0);

TUNABLE(IIR_MIN_DEPTH, 4, 0, 0, 0);
TUNABLE(IIR_TABLE_DEPTH_MARGIN, 5, 0, 0, 0);
...
TUNABLE(SE_TABLE_DEPTH_MARGIN, 3, 0, 0, 0);
