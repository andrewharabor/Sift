...
static constexpr Int32 TIME_STABILITY_SCALE_MIN_DEPTH = 6;
...
TUNABLE(TT_CUTOFF_BONUS_BASE, 100, 0, 0, 0);
TUNABLE(TT_CUTOFF_BONUS_DEPTH_SCALE, 175, 0, 0, 0);
TUNABLE(TT_CUTOFF_BONUS_MAX, 2000, 0, 0, 0);

TUNABLE(EVAL_POLICY_BONUS_BASE, 503, 0, 0, 0);
TUNABLE(EVAL_POLICY_BONUS_GAIN_SCALE, 10, 0, 0, 0);
TUNABLE(EVAL_POLICY_BONUS_MIN, -1038, 0, 0, 0);
TUNABLE(EVAL_POLICY_BONUS_MAX, 1944, 0, 0, 0);

TUNABLE(QUIET_BONUS_BASE, 159, 0, 0, 0);
TUNABLE(QUIET_BONUS_DEPTH_SCALE, 101, 0, 0, 0);
TUNABLE(QUIET_BONUS_MAX, 1818, 0, 0, 0);

TUNABLE(QUIET_PENALTY_BASE, 112, 0, 0, 0);
TUNABLE(QUIET_PENALTY_DEPTH_SCALE, 155, 0, 0, 0);
TUNABLE(QUIET_PENALTY_MAX, 1710, 0, 0, 0);

TUNABLE(NOISY_BONUS_BASE, 60, 0, 0, 0);
TUNABLE(NOISY_BONUS_DEPTH_SCALE, 204, 0, 0, 0);
TUNABLE(NOISY_BONUS_MAX, 2282, 0, 0, 0);

TUNABLE(QUIET_MOVE_NOISY_PENALTY_BASE, 169, 0, 0, 0);
TUNABLE(QUIET_MOVE_NOISY_PENALTY_DEPTH_SCALE, 57, 0, 0, 0);
TUNABLE(QUIET_MOVE_NOISY_PENALTY_MAX, 1368, 0, 0, 0);

TUNABLE(NOISY_MOVE_NOISY_PENALTY_BASE, 133, 0, 0, 0);
TUNABLE(NOISY_MOVE_NOISY_PENALTY_DEPTH_SCALE, 71, 0, 0, 0);
TUNABLE(NOISY_MOVE_NOISY_PENALTY_MAX, 1487, 0, 0, 0);

TUNABLE(POST_LMR_PENALTY_BASE, 122, 0, 0, 0);
TUNABLE(POST_LMR_PENALTY_DEPTH_SCALE, 100, 0, 0, 0);
TUNABLE(POST_LMR_PENALTY_MAX, 1227, 0, 0, 0);

TUNABLE(POST_LMR_BONUS_BASE, 180, 0, 0, 0);
TUNABLE(POST_LMR_BONUS_DEPTH_SCALE, 177, 0, 0, 0);
TUNABLE(POST_LMR_BONUS_MAX, 1980, 0, 0, 0);

TUNABLE(HISTORY_FDEPTH_EVAL_SCALE, 128, 0, 0, 0);
...
TUNABLE(RAZORING_MARGIN_DEPTH_SCALE, 347, 0, 0, 0);
TUNABLE(RAZORING_MAX_FDEPTH, 512, 0, 0, 0);
TUNABLE(RAZORING_MAX_ABS_ALPHA, 2000, 0, 0, 0);
...
TUNABLE(NMP_FREDUCTION_BASE, 424, 0, 0, 0);
TUNABLE(NMP_FREDUCTION_FDEPTH_SCALE, 200, 0, 0, 0);
TUNABLE(NMP_FREDUCTION_EVAL_SCALE, 82, 0, 0, 0);
TUNABLE(NMP_FREDUCTION_EVAL_MAX, 384, 0, 0, 0);
...
TUNABLE(SE_TT_FDEPTH_MARGIN, 348, 0, 0, 0);
...
TUNABLE(SE_NEG_FEXTENSION, 384, 0, 0, 0);
TUNABLE(SE_CUTNODE_NEG_FEXTENSION, 256, 0, 0, 0);

TUNABLE(LDSE_MAX_FDEPTH, 896, 0, 0, 0);
TUNABLE(LDSE_SINGLE_FEXT_MARGIN, 22, 0, 0, 0);
TUNABLE(LDSE_DOUBLE_FEXT_MARGIN, 39, 0, 0, 0);
TUNABLE(LDSE_DOUBLE_FEXT_TT_FDEPTH_MARGIN, 348, 0, 0, 0);
...
TUNABLE(LMR_FREDUCTION_OFFSET, -37, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_QUIET_HISTORY_SCALE, 447, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_NOISY_HISTORY_SCALE, 423, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_NON_PV_SCALE, 1069, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_TT_PV_SCALE, 1146, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_IMPROVING_SCALE, 1242, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_GIVES_CHECK_SCALE, 852, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_CUT_NODE_SCALE, 1945, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_TT_PV_FAIL_LOW_SCALE, 1054, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_NOISY_TT_MOVE_SCALE, 1081, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_MOVES_TRIED_SCALE, 42, 0, 0, 0);
TUNABLE(LMR_FREDUCTION_COMPLEXITY_SCALE, 480, 0, 0, 0);
