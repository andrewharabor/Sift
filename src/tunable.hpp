...
TUNABLE(PAWN_CORR_HIST_WEIGHT, 209, 0, 0, 0);
TUNABLE(FRIENDLY_NONPAWN_CORR_HIST_WEIGHT, 194, 0, 0, 0);
TUNABLE(ENEMY_NONPAWN_CORR_HIST_WEIGHT, 137, 0, 0, 0);
TUNABLE(THREAT_CORR_HIST_WEIGHT, 114, 0, 0, 0);
TUNABLE(MINOR_PIECE_CORR_HIST_WEIGHT, 133, 0, 0, 0);
TUNABLE(MAJOR_PIECE_CORR_HIST_WEIGHT, 202, 0, 0, 0);
...
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT2, 174, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT3, 88, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT4, 115, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT5, 109, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT6, 82, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT7, 71, 0, 0, 0, []() { ContCorrHistWeights::init(); });
...
TUNABLE(CORR_HIST_CORRECTION_DIVISOR, 2048, 0, 0, 0);
