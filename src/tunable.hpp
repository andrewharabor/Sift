...
TUNABLE(STABILITY_SCALE_MIN_DEPTH, 6, 0, 0, 0);
...
TUNABLE(CORR_HISTORY_DEPTH_WEIGHT_SCALE, 2, 0, 0, 0);
TUNABLE(CORR_HISTORY_DEPTH_WEIGHT_MAX, 16, 0, 0, 0);
...
TUNABLE(NMP_NO_VERIFICATION_MAX_DEPTH, 15, 0, 0, 0);
TUNABLE(NMP_MIN_PLY_DEPTH_SCALE, 3, 0, 0, 0); // FIXME: don't tune?
TUNABLE(NMP_MIN_PLY_DEPTH_DIVISOR, 4, 0, 0, 0); // FIXME: don't tune?

TUNABLE(PROBCUT_MIN_DEPTH, 5, 0, 0, 0);
...
TUNABLE(LMR_MIN_DEPTH, 3, 0, 0, 0);
TUNABLE(LMR_MIN_MOVES_PV, 4, 0, 0, 0);
TUNABLE(LMR_MIN_MOVES_NON_PV, 3, 0, 0, 0);
...
TUNABLE(NOISY_FP_MAX_DEPTH, 5, 0, 0, 0);
...
TUNABLE(HISTORY_PRUNING_MAX_DEPTH, 7, 0, 0, 0);
TUNABLE(HISTORY_PRUNING_MARGIN, -1743, 0, 0, 0);
TUNABLE(HISTORY_BETA_MARGIN, 39, 0, 0, 0);

TUNABLE(SE_ROOT_DEPTH_SCALE, 2, 0, 0, 0);
TUNABLE(SE_MIN_DEPTH, 5, 0, 0, 0);
...
TUNABLE(SE_DEPTH_OFFSET, -1, 0, 0, 0);
TUNABLE(SE_DEPTH_DIVISOR, 2, 0, 0, 0);
TUNABLE(SE_DOUBLE_EXT_MARGIN, 10, 0, 0, 0);
TUNABLE(SE_TRIPLE_EXT_MARGIN, 124, 0, 0, 0);

TUNABLE(QSEARCH_MAX_MOVES, 2, 0, 0, 0);
...
TUNABLE(EVAL_ADJUST_KNIGHT_SCALE, 384, 0, 0, 0);
TUNABLE(EVAL_ADJUST_BISHOP_SCALE, 384, 0, 0, 0);
TUNABLE(EVAL_ADJUST_ROOK_SCALE, 640, 0, 0, 0);
TUNABLE(EVAL_ADJUST_QUEEN_SCALE, 1280, 0, 0, 0);
TUNABLE(EVAL_ADJUST_MATERIAL_BASE, 25600, 0, 0, 0);
