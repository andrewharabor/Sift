...
TUNABLE(THREAT_CORR_HIST_WEIGHT, 29, 0, 0, 0);
TUNABLE(MINOR_PIECE_CORR_HIST_WEIGHT, 233, 0, 0, 0);
...
static inline ContCorrHistWeightsTable CONT_CORR_HIST_WEIGHTS;
...
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT2, 44, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT3, 22, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT4, 29, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT5, 27, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT6, 20, 0, 0, 0, []() { ContCorrHistWeights::init(); });
TUNABLE_CALLBACK(CONT_CORR_HIST_WEIGHT7, 18, 0, 0, 0, []() { ContCorrHistWeights::init(); });

static inline void ContCorrHistWeights::init() { CONT_CORR_HIST_WEIGHTS = {0, 0, CONT_CORR_HIST_WEIGHT2, CONT_CORR_HIST_WEIGHT3, CONT_CORR_HIST_WEIGHT4, CONT_CORR_HIST_WEIGHT5, CONT_CORR_HIST_WEIGHT6, CONT_CORR_HIST_WEIGHT7}; }

TUNABLE(HISTORY_BONUS_MAX, 2036, 0, 0, 0);
TUNABLE(HISTORY_BONUS_QUADRATIC_DIVISOR, 64, 0, 0, 0);
TUNABLE(HISTORY_BONUS_QUADRATIC_SCALE, 441, 0, 0, 0);
TUNABLE(HISTORY_BONUS_LINEAR_SCALE, 219, 0, 0, 0);
TUNABLE(HISTORY_BONUS_OFFSET, 98, 0, 0, 0);

TUNABLE(HISTORY_PENALTY_MAX, 1093, 0, 0, 0);
TUNABLE(HISTORY_PENALTY_QUADRATIC_DIVISOR, 64, 0, 0, 0);
TUNABLE(HISTORY_PENALTY_QUADRATIC_SCALE, 292, 0, 0, 0);
TUNABLE(HISTORY_PENALTY_LINEAR_SCALE, 302, 0, 0, 0);
TUNABLE(HISTORY_PENALTY_OFFSET, 27, 0, 0, 0);

TUNABLE(CORR_HIST_BONUS_MAX, 256, 0, 0, 0);
TUNABLE(CORR_HIST_PENALTY_MAX, 256, 0, 0, 0);
TUNABLE(CORR_HIST_CORRECTION_DIVISOR, 1024, 0, 0, 0);
