...
public:
    ...
    static Int32 adjust(Int32 score, const Position &position, const std::array<Int32, 2> &optimism, Int32 correction = 0) noexcept {
        ...
        const Int32 optimismBonus = optimism[static_cast<USize>(position.sideToMove())] * (EVAL_ADJUST_OPTIMISM_SCALE_BASE + EVAL_ADJUST_OPTIMISM_SCALE_MATERIAL_SCALE * material / 1024);
