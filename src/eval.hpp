...
public:
    ...
    static Int32 adjust(Int32 score, const Position &position) {
    ...
    static Int32 adjusted(const Position &position, NNUE &nnue, const std::array<Int32, 2> &contempt) { return adjust(raw(position, nnue, contempt), position); }
};
