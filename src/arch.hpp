...
public:
    ...
    inline bool load(ByteReader &reader) noexcept { return reader.load(l1Weights) && reader.load(l1Biases) && reader.load(l2Weights) && reader.load(l2Biases) && reader.load(l3Weights) && reader.load(l3Biases); }
