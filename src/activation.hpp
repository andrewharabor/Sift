...
namespace Sift {
    struct ReLUActivation {
        template<Int16 MAX>
        static FORCE_INLINE WidenedVec<Int16> actDotAcc(WidenedVec<Int16> sum, Vec<Int16> inputs, Vec<Int16> weights) noexcept {
        ...
        template<Int32 MAX>
        static FORCE_INLINE Int32 output(Int32 value) noexcept {
            return value;
        }
    };
